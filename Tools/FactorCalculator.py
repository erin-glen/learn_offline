...
#code to return only factors from forest table (and convert to CO2)
    ...
    forestAge['Annual_Emissions_Fire_CO2'] = ((forestAge['fire_HA'] * forestAge['Fire Emissions Factor']) * (44/12)
                                              / (int(year2) - int(year1)))
    forestAge['Annual_Emissions_Harvest_CO2'] = ((forestAge['harvest_HA'] * forestAge['Harvest Emissions Factor']) * (44 / 12)
                                                / (int(year2) - int(year1)))
    forestAge['Annual_Emissions_Insect_CO2'] = ((forestAge['insect_damage_HA'] * forestAge['Insect Emissions Factor']) * (44 / 12)
                                              / (int(year2) - int(year1)))
